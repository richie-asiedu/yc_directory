...
export const defaultStartupCards: StartupCard[] = [
	{
		_id: "1",
		_createdAt: "2025-10-01T00:00:00Z",
		slug: { current: "ecotrack" },
		title: "EcoTrack",
		author: "Steven Smith",
		views: 232,
		image: "/des1.png",
		...
		highlight: true,
		category: "Technology",
		pitch: "EcoCart is an innovative e-commerce platform designed for eco-conscious shoppers looking to make a positive environmental impact with their purchases.",
		id: 1,
	},
	{
		_id: "2",
		_createdAt: "2025-05-10T00:00:00Z",
		slug: { current: "smiths-class-of-genius" },
		...
		highlight: true,
		category: "Education",
		pitch: "An online platform connecting creative minds to collaborate and innovate together.",
		id: 2,
	},
	{
		_id: "3",
		_createdAt: "2024-12-10T00:00:00Z",
		slug: { current: "codertech-class" },
		...
		highlight: true,
		category: "Education",
		pitch: "Learn coding with interactive lessons and real-world projects for all skill levels.",
		id: 3,
	},
	{
		_id: "4",
		_createdAt: "2024-08-20T00:00:00Z",
		slug: { current: "cakes-mastery-class" },
		...
		highlight: true,
		category: "Culinary",
		pitch: "Master the art of baking with step-by-step video tutorials and expert tips.",
		id: 4,
	},
	{
		_id: "5",
		_createdAt: "2023-06-30T00:00:00Z",
		slug: { current: "jakes-mastery-class" },
		...
		pitch: "Unlock your potential with personalized coaching and hands-on workshops.",
		id: 5,
	},
	{
		_id: "6",
		_createdAt: "2023-05-02T00:00:00Z",
		slug: { current: "evans-special-class" },
		...
		highlight: true,
		category: "Technology",
		pitch: "Advance your web development skills with live sessions and mentorship.",
		id: 6,
	},
	{
		_id: "7",
		_createdAt: "2023-04-05T00:00:00Z",
		slug: { current: "ahcid-da-designers-mastery-class" },
		...
		highlight: true,
		category: "Design",
		pitch: "Design like a pro with exclusive resources and a supportive creative community.",
		id: 7,
	},
	{
		_id: "8",
		_createdAt: "2022-09-28T00:00:00Z",
		slug: { current: "richdev-mastery-class" },
		...
		highlight: true,
		category: "Technology",
		pitch: "Grow your tech career with expert-led masterclasses and networking events.",
		id: 8,
	},
];